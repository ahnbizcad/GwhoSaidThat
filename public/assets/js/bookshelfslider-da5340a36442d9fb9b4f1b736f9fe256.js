...
(function($){
	...
	$.bookshelfSlider = function(selector, settings) {
		...
		$(selector + ' .product').each(function(i) {
			...
			if (data_type == 'book') {
				$prod.append("<img class='fx_book' id='b_" + i + "' + src='" + folderAssets + "/book_fx.png' />");
				...
				$prod.append("<img class='fx_magazine' id='m_" + i + "' + src='" + folderAssets + "/magazine_fx.png' />");
				...
				$prod.append("<img class='fx_cd' id='cd_" + i + "' + src='" + folderAssets + "/cd_fx.png' />");
				...
				$prod.append("<img class='fx_cd' id='dvd_" + i + "' + src='" + folderAssets + "/dvd_fx.png' />");
		...
		$(selector + ' .product').click(function(e) {
			...
			$('#popup_info').append("<img id='preload_icon' src='" + folderAssets + "/preload.gif' />");
